    ...
    <div className="estate-summary-sticky">
      <div className="estate-summary-group">
        <div>
          ...
          <span>{currency_sign}{netIrishEstate.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
        </div>
        <div>
          <span className="fw-bold">Lendable Irish Estate<sup>*</sup>: </span>
          <span>{currency_sign}{lendableIrishEstate.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
        </div>
        <div>
          <span className="fw-bold">Maximum Advance (50%): </span>
          <span>{currency_sign}{(lendableIrishEstate * 0.5).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
        </div>
      </div>
      <div className="estate-summary-group">
        {(() => {
